...
route.post("/practice/evaluate", userController.evaluatePracticeQuestion);
route.get("/practice/history", userController.getPracticeHistory);
route.get("/results", userController.getStudentResultOverview);
route.get("/quiz-attempts/:id/result", quizAttemptController.getStudentQuizResult);
